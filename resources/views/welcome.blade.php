...
<body class="antialiased">
    <div
        class="relative flex items-top justify-center min-h-screen bg-stone-100 dark:bg-stone-900 sm:items-center sm:pt-0">
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                @auth
                    <a href="{{ url('/dashboard') }}" class="text-sm text-stone-700 underline">Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="text-sm text-stone-700 underline">Login</a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="ml-4 text-sm text-stone-700 underline">Register</a>
                    @endif
            @endif
        </div>
        @endif
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <svg viewBox="0 0 651 192" fill="none" xmlns="http://www.w3.org/2000/svg"
                    class="h-16 w-auto text-stone-700 sm:h-20">
            ...
            <div class="mt-8 bg-white dark:bg-stone-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-stone-500">
                                <path
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs"
                                    class="underline text-stone-900 dark:text-white">Documentation</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-stone-600 dark:text-stone-400 text-sm">
                    ...
                    <div class="p-6 border-t border-stone-200 dark:border-stone-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-stone-500">
                                <path
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laracasts.com"
                                    class="underline text-stone-900 dark:text-white">Laracasts</a></div>
                        </div>
                    ...
                    <div class="p-6 border-t border-stone-200 dark:border-stone-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel-news.com/"
                                    class="underline text-stone-900 dark:text-white">Laravel News</a></div>
                        </div>
                    ...
                    <div class="p-6 border-t border-stone-200 dark:border-stone-700 md:border-l">
                        <div class="flex items-center">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-stone-500">
                                <path
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold text-stone-900 dark:text-white">Vibrant
                                Ecosystem</div>
                        </div>
            ...
            <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                <div class="text-center text-sm text-stone-500 sm:text-left">
                    <div class="flex items-center">
                        <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            viewBox="0 0 24 24" stroke="currentColor" class="-mt-px w-5 h-5 text-stone-400">
                            <path
                        ...
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2" viewBox="0 0 24 24" class="ml-4 -mt-px w-5 h-5 text-stone-400">
                            <path
                ...
                <div class="ml-4 text-center text-sm text-stone-500 sm:text-right sm:ml-0">
