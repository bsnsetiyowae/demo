...
| `BJB`                    | Bank BANTEN(Bank BJB)                            |
| `BJB SYARIAH`            | Bank BANTEN(Bank BJB SYARIAH)                    |
| `CIMB`                   | Bank CIMB Niaga                                  |
| `CIMB SYARIAH`           | Bank CIMB SYARIAH                                |
| `CAPITAL`                | Bank Capital Indonesia                           |
| `COMMONWEALTH`           | Bank Commonwealth                                |
| `DANAMON`                | Bank Danamon                                     |
| `DANAMON SYARIAH`        | Bank Danamon SYARIAH                             |
...
| `BANK_INDOMONEX`         | Bank Indomonex (Bank SBI Indonesia)              |
...
| `SINARMAS SYARIAH`       | Bank Sinarmas SYARIAH                            |
| `BTN SYARIAH`            | Bank BTN SYARIAH                                 |
| `BISNIS`                 | Bisnis International                             |
| `JPMORGAN`               | JPMorgan Chase Bank                              |
| `SHINHAN`                | Bank SHINHAN                                     |
| `IBK`                    | Bank Agris Prima(IBK)                            |
| `MIZUHO`                 | MIZUHO                                           |
