---
title: Otentikasi & Keamanan
---

## Otentikasi

Anda perlu mengotentikasi permintaan Anda untuk mengakses salah satu titik akhir dalam API {brand}. {brand} menawarkan otentikasi menggunakan dua jenis token: `api_key` dan `secret_key`. Token-token ini digunakan untuk mengenkripsi parameter dalam setiap permintaan.

Parameter-parameter yang terenkripsi didekripsi dan divalidasi oleh sistem kami menggunakan token yang sama dalam catatan kami. Setelah validasi berhasil, permintaan diproses, dan respons dikembalikan.

---

## Keamanan

Kami memiliki algoritma sendiri untuk membuat permintaan ke titik akhir kami. Algoritma ini merujuk pada [prasyarat keamanan](/docs/pre-requirements) yang memerlukan pembuatan kunci untuk setiap transaksi.

## Kode Template
Kami menyediakan beberapa potongan kode untuk membantu dalam pengembangan.
